		...
		<div className="container mx-auto max-w-6xl px-4 md:px-6 pt-32 pb-16">
			<div className="space-y-8">
				...
				<div className="prose prose-lg max-w-none prose-p:text-muted-foreground prose-headings:text-foreground">
					...
					<p>
						QuitGambling provides a mobile application and related services
						designed to help individuals overcome gambling addiction. Our
						services include tracking tools, educational resources, and support
						features.
					</p>
					...
					<p>
						Your use of QuitGambling&apos;s services is also governed by our
					...
					<p>
						QuitGambling reserves the right to modify or discontinue,
						temporarily or permanently, the service with or without notice. You
						agree that QuitGambling shall not be liable to you or any third
