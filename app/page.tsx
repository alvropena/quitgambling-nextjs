						...
						<div className="flex flex-col items-center space-y-4 text-center">
							<div className="space-y-2">
								...
								<p className="mx-auto max-w-[700px] text-gray-700 md:text-xl">
									QuitGambling helps you overcome gambling addiction with
							...
							<Accordion type="single" collapsible className="w-full">
								...
								>
									...
									<AccordionContent className="text-gray-700">
										...
										tracking, and community support to help you overcome
										gambling addiction and maintain sobriety. Our app provides
										tools to identify triggers, track your progress, and connect
								...
								>
									...
									<AccordionContent className="text-gray-700">
										...
										consent. We understand the sensitive nature of recovery and
